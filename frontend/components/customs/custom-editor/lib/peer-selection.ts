...
import { PeerSelectionRange, PeerEditorSelectionJSON } from '@repo/collaboration-types'
import { PeerSelectionState, peerSelectionField, peerSelectionsAnnotation } from './peer-selection-state'
import { Facet, combineConfig } from '@codemirror/state'
import { noop } from './utils'

import { PeerSelectionConfigOptions, PeerSelectionFullConfig } from '@repo/collaboration-types'
...
class PeerSelectionPlugin {
    ...
    _subscribeToRemoteSelections() {
        this.config.onReceiveSelection((clientID: string, peerSelectionJson: PeerEditorSelectionJSON | null) => {
            this.view.dispatch({
