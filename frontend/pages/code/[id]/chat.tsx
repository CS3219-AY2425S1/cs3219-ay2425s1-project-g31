...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        const s = socketIO.connect(`${window.location.origin}`); 
                ...
                {!!chatData.length &&
                    chatData.map((chat, index) => (
                        ...
                        >
                            ...
                            <div
                                className={`text-sm py-2 px-3 break-words w-full ${getChatBubbleFormat({ name: chat.name, email: chat.email }, 'text')}`}
                            >
                                {chat.text}
                            </div>
                        </div>
